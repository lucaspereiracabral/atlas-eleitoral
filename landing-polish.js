...
function injectStyles(){
 ...
 @media(max-width:900px){.inst-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.inst-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:600px){.inst-shell{padding:17px;border-radius:17px}.inst-grid,.inst-metrics{grid-template-columns:1fr}.inst-title{font-size:20px}.inst-card{min-height:112px}.inst-secondary-head{align-items:flex-start;flex-direction:column;gap:7px}.inst-source{text-align:left}.inst-metric{min-height:auto}}
...
function buildInstitutional(){
 ...
 <div class="inst-shell">
   ...
   <div class="inst-secondary">
    <div class="inst-secondary-head">
     <div><div class="inst-section-kicker">Educação e desenvolvimento</div><div class="inst-section-title">Indicadores municipais selecionados</div></div>
     <div class="inst-source">Fonte: IBGE Cidades e Estados • períodos conforme cada indicador</div>
    </div>
    <div class="inst-metrics">
     <article class="inst-metric"><div class="inst-metric-label">Escolarização de 6 a 14 anos</div><div class="inst-metric-value">99,13%</div><div class="inst-metric-note">2022</div></article>
     <article class="inst-metric"><div class="inst-metric-label">IDEB • anos iniciais</div><div class="inst-metric-value">6,2</div><div class="inst-metric-note">Rede pública • 2023</div></article>
     <article class="inst-metric"><div class="inst-metric-label">IDEB • anos finais</div><div class="inst-metric-value">5,2</div><div class="inst-metric-note">Rede pública • 2023</div></article>
     <article class="inst-metric"><div class="inst-metric-label">Matrículas na educação básica</div><div class="inst-metric-value compact">37.595 fundamental<br>10.675 ensino médio</div><div class="inst-metric-note">2025</div></article>
     <article class="inst-metric"><div class="inst-metric-label">PIB per capita</div><div class="inst-metric-value">R$ 182.522,93</div><div class="inst-metric-note">2023</div></article>
     <article class="inst-metric"><div class="inst-metric-label">IDHM</div><div class="inst-metric-value">0,795</div><div class="inst-metric-note">2010</div></article>
    </div>
   </div>
 </div>`;
